...
<main>
  <div class="mv">
    <picture>
      <source
        ...
        srcset="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/mv_sp.avif"
        type="image/avif">
      <source
        media="(max-width: 767px)"
        srcset="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/mv_sp.webp"
        type="image/webp">
      <source
        media="(max-width: 767px)"
        srcset="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/mv_sp.jpg">

      <source
        srcset="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/mv.avif"
        type="image/avif">
      <source
        srcset="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/mv.webp"
        type="image/webp">

      <img
        src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/mv.jpg"
  ...
  <section class="attention sec -md">
    <div class="contents">
      <div class="attention--strong">
        <h2>上記に当てはまる場合<br><img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/attention_txt.png" alt="" width="491" height="83">が必要です</h2>
    ...
    <div class="contents">
      <div class="cvarea--lead">
        <picture>
          ...
          <img class="cvarea--bg" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/cvarea.png" alt="エアコンクリーニングならトータルスマートにお任せください" width="1366" height="618" decoding="async">
        </picture>
        <div class="header--btns">
          <div class="header--btn-item">
            <a href="tel:052-932-5450" class="cv_button">
        ...
        <p>様々な店舗・オフィスにて幅広く対応中！</p>
      </div>
      <div class="cvarea--inner">
        <div>
          <span>飲食店</span>
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/instance_01.jpg" alt="" width="350" height="250" decoding="async">
        </div>
        <div>
          <span>美容院</span>
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/instance_02.jpg" alt="" width="350" height="250" decoding="async">
        </div>
        <div>
          <span>車屋</span>
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/instance_03.jpg" alt="" width="350" height="250" decoding="async">
        </div>
        <div>
          <span>アパレル</span>
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/instance_04.jpg" alt="" width="350" height="250" decoding="async">
        </div>
        <div>
          <span>塾</span>
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/instance_05.jpg" alt="" width="350" height="250" decoding="async">
        </div>
        <div>
          <span>医療</span>
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/instance_06.jpg" alt="" width="350" height="250" decoding="async">
        </div>
      </div>
    </div>
  </section>
  <section class="select sec">
    <div class="contents">
      <h2>
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/select_logo.png" alt="株式会社トータルスマート" width="401" height="44" decoding="async">が<br>選ばれる<span>4</span>つの理由
      </h2>
    ...
    <div class="contents">
      ...
      <div class="voice--inner">
        <div class="voice--item">
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/voice_01.jpg" alt="" width="380" height="200" decoding="async">
          <div>
        ...
        <div class="voice--item">
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/voice_02.jpg" alt="" width="380" height="200" decoding="async">
          <div>
        ...
        <div class="voice--item">
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/voice_03.jpg" alt="" width="380" height="200" decoding="async">
          <div>
    ...
    <div class="contents">
      ...
      <ol>
        <li>
          <div class="use--txt">
            <h3>お問い合わせ</h3>
            <img class="is-hidden_pc" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_01.jpg" alt="" width="250" height="250" decoding="async">
            <p>サービスの詳細、気になっている汚れやお掃除したい箇所についてなど、
              お電話またはメールフォームにてお気軽にお問い合わせください。</p>
          </div>
          <div>
            <img class="is-hidden_sp" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_01.jpg" alt="" width="250" height="250" decoding="async">
          </div>
        </li>
        <li>
          <div class="use--txt">
            <h3>ヒアリング</h3>
            <img class="is-hidden_pc" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_02.jpg" alt="" width="250" height="250" decoding="async">
            <p>
          ...
          <div>
            <img class="is-hidden_sp" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_02.jpg" alt="" width="250" height="250" decoding="async">
          </div>
        </li>
        <li>
          <div class="use--txt">
            <h3>お見積りご提示</h3>
            <img class="is-hidden_pc" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_03.jpg" alt="" width="250" height="250" decoding="async">
            <p>
          ...
          <div>
            <img class="is-hidden_sp" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_03.jpg" alt="" width="250" height="250" decoding="async">
          </div>
        </li>
        <li>
          <div class="use--txt">
            <h3>スケジュールの相談</h3>
            <img class="is-hidden_pc" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_04.jpg" alt="" width="250" height="250" decoding="async">
            <p>お見積りから正式にご依頼をいただいたのち、サービス実施日時やスケジュールについて相談させていただきます。</p>
          </div>
          <div>
            <img class="is-hidden_sp" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_04.jpg" alt="" width="250" height="250" decoding="async">
          </div>
        </li>
        <li>
          <div class="use--txt">
            <h3>サービス実施</h3>
            <img class="is-hidden_pc" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_05.jpg" alt="" width="250" height="250" decoding="async">
            <p>担当スタッフが訪問し、サービスを実施します。お見積り以上の請求が発生することはありませんが、追加のご要望などがあれば請求額が変わる場合もございます。</p>
          </div>
          <div>
            <img class="is-hidden_sp" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_05.jpg" alt="" width="250" height="250" decoding="async">
          </div>
        </li>
        <li>
          <div class="use--txt">
            <h3>お支払い</h3>
            <img class="is-hidden_pc" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_06.jpg" alt="" width="250" height="250" decoding="async">
            <p>お支払い方法は現金・銀行振込・クレジットカードがご利用いただけます。 <br>
              銀行振込をご利用の場合の振込先はお見積りの際にご案内いたします。</p>
          </div>
          <div>
            <img class="is-hidden_sp" src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/use_06.jpg" alt="" width="250" height="250" decoding="async">
          </div>
        </li>
      </ol>
    </div>
  ...
  <section class="region sec">
    <div class="contents -md">
      ...
      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/shuurilp/img/map.png" alt="" width="518" height="534" decoding="async">
      <dl>
        <div>
          <dt>
            愛知エリア
    ...
    <div class="contents -md">
      ...
      <dl>
        ...
        <div>
          ...
          <dd>
            現金以外にクレジットカードがご使用頂けます。<br>
            予めお伝えください。
          </dd>
        </div>
        <div>
          <dt>
            作業してもらう際、こちらで何かすることはありますか？
          </dt>
          <dd>
            特にございません。<br>
